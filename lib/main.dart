...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'RPS'),
    );
  }
}

class RPSButton extends StatelessWidget {
  final String buttonText;
  final void Function()? onPressed;
  const RPSButton(this.buttonText, {Key? key, this.onPressed})
      : super(key: key);
...
class _RPSGameState extends State<RPSGame> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        _pressedButton != null
            ? Text('you pressed $_pressedButton')
